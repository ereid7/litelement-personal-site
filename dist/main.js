...
class ToggleButton extends lit_element__WEBPACK_IMPORTED_MODULE_0__["LitElement"] {
  ...
  onChange(e) {
    ...
    this.performUpdate();
    let event = this.darkMode ? new CustomEvent('darkMode', {
      bubbles: true,
      composed: true
